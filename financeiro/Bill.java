...
//  		System.out.println("-----------------------------------------------------------\n");
//  		System.out.println("Conta está paga, não posso cancelar:");
...
//  	} else if(this.getBillSituation().equals(BillSituation.CANCELED)) {
  		
//  		System.out.println("-----------------------------------------------------------\n");
//  		System.out.println("Conta já foi cancelada:");
//			System.out.println("Descrição da conta: " + description + " valor: " + value + 
